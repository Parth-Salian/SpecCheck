...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Radio ButtonView Program
        radioGroupRegisterGender = findViewById(R.id.radio_group_register_gender);
        radioGroupRegisterGender.clearCheck();

        //Setting  up DatePicker on the edittext
        editTextRegisterPwd.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(textFullName)){
                    ...
                    Toast.makeText(RegisterActivity.this, "Please register your email", Toast.LENGTH_LONG).show();
                    editTextRegisterEmail.setError("Valid email si required");
                    editTextRegisterEmail.requestFocus();
                    ...
                    radioButtonRegisterGenderSelected.setError("Enter Valid Mobile number");
                    radioButtonRegisterGenderSelected.requestFocus();
                }else if (textMobile.length() != 10){
                    Toast.makeText(RegisterActivity.this, "Please Re-Enter Mobile No.", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError("Enter 10 digits mobile number");
                    editTextRegisterMobile.requestFocus();
                }else if (!mobileMatcher.find()){
                    Toast.makeText(RegisterActivity.this, "Please Re-Enter Mobile No.", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError("MPlease enter a valid mobile number");
                    editTextRegisterMobile.requestFocus();
                }
    ...
    //Register user using the credentials givem
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    try {
                        ...
                        editTextRegisterPwd.setError("Your password is too weak. Kindly use a longer and stronger password ");
                        editTextRegisterPwd.requestFocus();
                    }catch(FirebaseAuthInvalidCredentialsException e){
                        editTextRegisterPwd.setError("Email is invalid or already in use. Kindly enter valid email.");
                        editTextRegisterPwd.requestFocus();
